module cla64_flat(
  ...
  // Continue the carry-lookahead through the remaining bits.
  // Each carry is expressed in terms of generate/propagate signals.

  assign #(2) c[5]  = g[4]  | (p[4]  & c[4]);
  assign #(2) c[6]  = g[5]  | (p[5]  & c[5]);
  assign #(2) c[7]  = g[6]  | (p[6]  & c[6]);
  assign #(2) c[8]  = g[7]  | (p[7]  & c[7]);
